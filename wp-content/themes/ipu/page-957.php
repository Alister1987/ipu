...
<article id="content_wrapper">
	<aside class="sidebar sb_filters two_column">
		<?php
			...
			$shortDesc = get_field('short_description', 957);
		?>
		...
		<div id="filters" class="sbf_filtergroup" data-group="type">
			...
			<div class="sbf_filter" id="cases"><input type="checkbox" name="gi_cases" value=".gi_cases" id="gi_cases"><label for="gi_cases">Case</label></div>
			<div class="sbf_filter" id="legislations"><input type="checkbox" name="gi_legislations" value=".gi_legislations" id="gi_legislations"><label for="gi_legislations">Legislation</label></div>
