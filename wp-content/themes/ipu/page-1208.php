		...
		<div class="item g_item gi_person gi_training">
					...
					<div class="gi_register">
						...
						<div class="gir_action">
							...
							<a class="btn btn_action_order" href="<?= $cfg["card_info_page_url"].$junction.'item='.get_the_ID() ?>">Order now</a>
                            <?php } ?>
							...
							<?php } else { ?>
								...
								<a class="btn btn_action_register guest_register" href="#">Register your interest - guest</a>
							<?php } ?>
							<!-- /Register interest -->
