<?php
/**
Template Name: IPU FAQ Resources
 *
 * @package WordPress
 * @subpackage IPU
					...
					<div class="slider_event">
						...
						<ul>
							...
							while ($query2->have_posts()) :
								...
								//update ******
								$shortDesc = $fields["short_description"];
								$avatar = wp_get_attachment_image_src(get_field('image'), 'high');
								...
								//event content
								?>
								<li class="slide_event" style="background-image: url('<?= $avatar[0]; ?>')">
