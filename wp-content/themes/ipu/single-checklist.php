...
<aside class="sidebar sb_single_item sb_single_article sb_single_checklist two_column">
<?php
while (have_posts()) : the_post();
	...
	$download  = wp_get_attachment_url(get_post_meta(get_the_ID(), 'files', true));
	?>		
			<div class="sb_wrapper sb_wrapper_stickit">
				...
				<?php if(!empty($download)){ ?>
					<a class="btn btn_si_download" href="<?= $download; ?>" title="Download">Download</a> 
				<?php } ?>
			</div>
		<?php endwhile; ?>
	...
	<div class="content si_content si_content_checklist eight_column">
