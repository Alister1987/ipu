...
<html <?php language_attributes(); ?>>
	...
	<head>
		...
		<!-- Open Sans Font -->
		<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,400italic,700,300italic' rel='stylesheet' type='text/css'>
				...
				<header>
					<div id="header">
						...
						<div class="network_menu">
							<ul>
								<?php wp_nav_menu(array('menu' => 'header-menu', 'menu_class' => 'ms_menu')); ?>
								<li class="btn btn_network">
									<div id="network_popup">
										<ul>
											<?php wp_nav_menu(array('menu' => 'header-network-menu')); ?>		
										</ul>
									</div>
								</li>		
							</ul>
							<a href="#" class="btn btn_darkgrey btn_contact">Contact Us</a>
						</div>	
