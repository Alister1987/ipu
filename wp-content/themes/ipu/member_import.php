...
$pharResults = mysql_query("select jos_users.name as fullname, ".
	...
	"where username IN( 'hodonoghue','pdaly1','greenes'".
	",'rbooth','jbrett','jeggleston','mdaly1','bwhelan','nanderson','cdeeney','joconnor4','hjcoburn','agibbons','gpower','phallahan','fhenry','dorourke','imclaren','ioconnell','atrang','fmillar','eryan1','enorval','ssidhu','gjohnston','lcollins'".
	",'sbradley','maljaafrehova','cmonaghan','msweeney','bhackett','sgawronski','sbyrnes','tbourke','aoneill1','sdlonergan','hslevin','cmckernan1','mhogan','smcgann-obrien','ebrophy','atmorganv','mgrier','nmcgibney','palogan','mbboissieux','embooth','dmfinn','amkenny','fomahony','jduffy-finn','nodoherty'".
	",'pcorkery','swong','bhughes','mguiney','cmmurphy','jmurphy3','cryan','amdornan','dmulligan','ecoconnor','dsweeney','mfarrell1','ramaxwell','smmcmanus','vemcgovern','ybuenodiaz','cowens','cmmooney','kfitzharris'".
	",'scollins2','adouglas','moreilly2','ccrowley','lkennedy','ehackett','pgriffin','tsmith','nhoran','aomahoney','sfburns','kodowd1','fnaughton','shughessparrow','carobinson','mmorrissey','ecurtin1','rmcaffrey','sosullivan4','aomccourt','cmcgee1'".
	",'shiggins','amcinerney','tslattery','jflattery','mslattery1','klfoley','rmurphy1','sfarrelly','lsherlock','egibbons1','bmoran','cacaldwell','mobrien','pjfitzpatrick','eridgeway'".
	",'eahern','jjcrowley','fjoyce','dorourke1','nbajalan','josullivan5','scasey','dosullivan6','ncarey','kfahy','amcmanus','gfeely','anineachtain','sjhughes','rcuddihy','kdaly','cmcauliffe','snevin','aoleary1','dkilcoyne','mdoyle2','joconnell2','rodolan','edaly1','awhelehan','jodwyer','modonnell','bjmcnamara','rwalsh1','aforde'".
	",'clonergan1','cjmcgarrity','cmakem','lventry','amacgrory','shofmanaite','cofloinn','smcguire','amcguigan','abheeran','estorrie','smorris','bwalsh1','emurphy2','mmccarthy3','gwdunne','slong','saregan','lmulligan')"
);
