...
<article id="content_wrapper">
		...
		<div class="content lp_content eight_column mk_pharmacy_content">
			...
			<section class="mk_about_services" id="pharmacy-services">
	 ...
	 ?>
			...
			<section class="mk_about_services mk_about_schemes"  id="medicine-schemes">
				<div class="box_wrapper box_w_purple box_huge">	
					<div class="box_inside">	
						<?php
						$title = get_field('medicine_schemes_title');
						$subtitle = get_field('medicine_schemes_subtitle');
						?>
				<?php if(!empty($title)){?>
						<h4><?=$title;?></h4>
			...
			<section class="mk_about_services mk_about_school" id="how-to-become-a-pharmacist">
...
?>
						...
						if (get_field('bottom_text_buttons')):
							...
							?>
								<div class="box_action">
									<a href="<?=$address;?>" class="btn btn_action_link_blue" target="_blank"><?=$title;?></a>
								</div>	
								<?php
							endwhile;
						endif;
			...
			<?php
				...
				?>
					<a href="<?=$link;?>" target="_blank" class="btn btn_action_link_w"><?=$name_link;?></a>
