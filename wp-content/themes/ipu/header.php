...
<head>
  ...
  <!-- alsd 051016-1400-->
  <!-- Open Sans Font -->
  <link href='//fonts.googleapis.com/css?family=Open+Sans:400,300,400italic,700,300italic' rel='stylesheet'
        type='text/css'>
  ...
  <link rel="apple-touch-icon" sizes="57x57"
        href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/apple-touch-icon-57x57.png">
  <link rel="apple-touch-icon" sizes="114x114"
        href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/apple-touch-icon-114x114.png">
  <link rel="apple-touch-icon" sizes="72x72"
        href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/apple-touch-icon-72x72.png">
  <link rel="apple-touch-icon" sizes="144x144"
        href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/apple-touch-icon-144x144.png">
  <link rel="apple-touch-icon" sizes="60x60"
        href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/apple-touch-icon-60x60.png">
  <link rel="apple-touch-icon" sizes="120x120"
        href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/apple-touch-icon-120x120.png">
  <link rel="apple-touch-icon" sizes="76x76"
        href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/apple-touch-icon-76x76.png">
  <link rel="apple-touch-icon" sizes="152x152"
        href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/apple-touch-icon-152x152.png">
  <link rel="apple-touch-icon" sizes="180x180"
        href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/apple-touch-icon-180x180.png">
  <link rel="icon" type="image/png" href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/favicon-192x192.png"
        sizes="192x192">
  <link rel="icon" type="image/png" href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/favicon-160x160.png"
        sizes="160x160">
  <link rel="icon" type="image/png" href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/favicon-96x96.png"
        sizes="96x96">
  <link rel="icon" type="image/png" href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/favicon-16x16.png"
        sizes="16x16">
  <link rel="icon" type="image/png" href="<?php bloginfo( 'template_directory' ); ?>/img/favicon/favicon-32x32.png"
        sizes="32x32">
  <meta name="msapplication-TileColor" content="#00a300"/>
  <meta name="msapplication-TileImage"
        content="<?php bloginfo( 'template_directory' ); ?>/img/favicon/mstile-144x144.png"/>
...
.isotope .isotope-item {
    ...
    <style>
      .si_section_content #tabs .n_content_same_height {
        overflow-y: scroll;
      }
    </style>
	<?php } ?>
  ...
  <header id="header_scroll" class="reg">
    ...
    <header id="header_scroll" class="">
      ...
      <div class="logo_wrapper">
        <a href="<?= home_url(); ?>"><img src="<?php bloginfo( 'template_directory' ); ?>/img/logo_mini_header.svg"
                                          alt="IPU" class="logo_header"></a>
      </div>
      ...
      <nav class="hs_sub_menu">
          ...
          <div class="breadcrumbs_wrapper">
              ...
              <a href="/professional">Professional</a>
                ...
                <a
                  href="<?php echo get_page_link( $parent_section ); ?>"><?php echo get_the_title( $parent_section ); ?></a>
                <a href="<?php echo get_page_link( $parent_page ); ?>"><?php echo get_the_title( $parent_page ); ?></a>
							<?php } else {
								...
								if ( $parentPostId ) { ?>
                  <a href="<?php echo get_page_link( $parentPostId ); ?>"
                     data-scroll=""><?php echo get_the_title( $parentPostId ); ?></a>
								<?php }
							} ?>
              <a href="#header" data-scroll=""><?php echo get_the_title(); ?></a>
						<?php } ?>
      ...
      <div class="searchbar">
        <form class="search_form" action="<?php echo home_url(); ?>" method="get" role="search">
          <label>
            ...
            <input type="text" class="search_field" placeholder="I'm looking for..." id='s'
                   value="<?php echo wp_specialchars( $s, 1 ); ?>" name="s" title="I'm looking for...">
        ...
        <div id="header">
          ...
          <div class="logo_wrapper">
            <a href="<?= get_permalink( 82 ); ?>" title="">
              <img src="<?php bloginfo( 'template_directory' ); ?>/img/logo_header.svg" alt="IPU"
                   class="logo_header logo_header_desktop">
              <img src="<?php bloginfo( 'template_directory' ); ?>/img/logo_mini_header.svg" alt="IPU"
                   class="logo_header logo_header_mobile">
            </a>
          </div>
    ...
    <header>
      <div id="mk_home_header">
        ...
        <div class="user_login">
          ...
          <div class="um_form">
            <form method="post" action="<?php print( get_site_url() ); ?>/wp-login.php?wpe-login=iputest" id="loginform"
                  name="loginform">
              ...
              <p class="umf_username">
                <label for="user_login">
                  <input type="text" size="20" value="" class="input" id="user_login" name="log"
                         placeholder="Your Username"></label>
              </p>
            ...
            <p class="lost">
              <a title="Password Lost and Found" href="<?= site_url() ?>/wp-login.php?action=lostpassword">Lost your
                password?</a>
            </p>
          </div>
        </div>
    ...
    <article id="main_img" class="mi_blocked">
      ...
      <!--					<article id="main_img" class="mk_main mk_page_main_img test-img">-->
			...
			$feature        = $image_url[0];
			?>
      <article id="main_img" class="mk_main mk_page_main_img classttt"
			         <?php if ( ( $feature != $featureDefault ) ) { ?>style="background-image: url('<?= $feature; ?>');" <?php } ?>>
        <div class="hero_wrapper <?php echo $empty_header_class ?>">
          ...
          <article id="main_img" class="mk_main">
            <div class="hero_wrapper <?php echo $empty_header_class ?>">
              ...
              <nav id="mk_home_main_menu" <?php if ( ! is_page( 1200 ) ) { ?> class='mk_page_main_menu'<?php } ?>>
                <div class="logo_wrapper">
                  <a href="<?= site_url() ?>" title="<?php the_title(); ?>">
                    ...
                    <img src="<?php bloginfo( 'template_directory' ); ?>/img/logo_maxi_header.svg" alt="IPU"
                         class="logo_header">
              ...
              <div class="top-image-header">
                <img src="<?php bloginfo( 'template_directory' ); ?>/img/ipu-web-youngwoman.png" alt="IPU"
                     class="logo_header">
              </div>
							<?php
							/*
