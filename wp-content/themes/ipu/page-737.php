...
<article id="content_wrapper">
	<aside class="sidebar sb_filters two_column">
		<?php
			...
			$shortDesc = get_field('short_description', 737);
		?>
		...
		<div id="filters" class="sbf_filtergroup" data-group="type">
			...
			<div class="sbf_filter" id="guidelinesprotocolscircularss"><input type="checkbox" name="gi_guidelinesprotocolscircularss" value=".gi_guidelinesprotocolscircularss" id="gi_guidelinesprotocolscircularss"><label for="gi_guidelinesprotocolscircularss">Guidelines, Protocols, Circulars</label></div>
			<div class="sbf_filter" id="ipucommunicationss"><input type="checkbox" name="gi_ipucommunicationss" value=".gi_ipucommunicationss" id="gi_ipucommunicationss"><label for="gi_ipucommunicationss">IPU Communications and Correspondence with the DoH HSE</label></div>
		</div>
	</aside>
	...
	<section class="content lp_content eight_column">
		...
		<div id="container" class=" grid_post">
			...
			<?php
				...
				$subpage = 'genericsubstitution_referencepricing';
