<div class="item g_item gi_person gi_vacant gi_<?= $location; ?> gi_<?= $category; ?> gi_<?= $position; ?> gi_<?php echo $post_type ?> <?php echo $giCatClasses ?>" data-time="<?= $date; ?>" data-category="<?= $post_type; ?>">
